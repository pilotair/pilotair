...
export function useMenu() {
  ...
  const loadMenus = useCallback(async () => {
    const response = await httpGet<Pilotair.Menus.MenuItem[]>("menu");
...
function mapMenuItems(items: Pilotair.Menus.MenuItem[]) {
...
function getMenu(menu: Pilotair.Menus.MenuItem): MenuItem | undefined {
  switch (menu.type) {
    case "Files":
      return {
